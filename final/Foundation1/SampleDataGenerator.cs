    ...
    private string[] _titles =
        {
            ...
            "Become An Expert On Dogs By Watching This Videos",
    ...
    private string[] _texts =
        {
            ...
            "Deeply categorically untrue. In that situation the loneliness and urge to self-destruct must be overwhelming.",
